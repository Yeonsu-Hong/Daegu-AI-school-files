...
// 밑에 형태가 비슷하다, 자바스크립트 안에 이미 있는 형태이고 콘솔 객체안에 있는 로그라는 메서드를 사용한 것이다.
student.sum(100, 200);
...
// str1 = "Nice";
// 원본 데이터(str1)만 수정되고 복사 데이터(str2)는 그대로임 // str2 = "Hello World"
// 원시타입의 특성

	str2 = "Nice";

// 이렇게 하면 원본인 str1 타입은 그대로 Hello World임
*/
...
// 자바스크립트로 버튼 기능 만들기
// 버튼을 클릭할때마다 아래에 있는 색상을 랜덤하게 가져와서 구현하기
...
// getElementById javscript에서 만들어 놓은것! 이 메서드는 주어진 문자열과 일치하는 id 속성을 가진 요소를 찾고, 이를 나타내는 Element 객체를 반환
...
btn.addEventListener('click', function() {
	...
	// console.log(random);
	 ...
	 // bg 객체안에있는 style porpery에 접근하고 그 안에 있는 backgroundcolor에 접근!
...
// 위와 같이 입력하면 unexpected token 'var'라고 에러가 뜬다.
// 이걸 막기 위해서 캐멀케이스, 스네이크케이스로 두단어로 조합하여서 변수를 만든다.
